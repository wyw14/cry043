CREATE TABLE IF NOT EXISTS specifications(id text PRIMARY KEY,document_id text NOT NULL,version integer NOT NULL,status text NOT NULL,revision bigint NOT NULL,idempotency_key text NOT NULL UNIQUE,payload jsonb NOT NULL,UNIQUE(document_id,version));
